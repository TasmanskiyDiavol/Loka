...
/poisk (название фильтраБ не забудьте поставить перед фильтром '#') - Поиск по фильтр(ам)""")
...
:Описание (Очень интересный квест много загадок): """)
        ...
        if text.count("#") > 0:
            ...
            bot.send_message(user, "Вы не указали объект поиска")
    else:
